...
## Вопросы
1. Не удалось подключить в [styles.less](/styles/styles.less) папку со стилями, проект собирался только если указать путь до файла ![](images/errors/yarn-error-less.png)
